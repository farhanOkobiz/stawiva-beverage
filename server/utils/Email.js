...
module.exports = class Email {
  constructor(user, url) {
    ...
    this.url = url;
    this.from = `Stamina Plus <${process.env.EMAIL_FROM}>`;
  }
  ...
  async sendWelcome() {
    const html = `
      <h1>Welcome to the Stamina Plus, ${this.firstName}!</h1>
      <p>We are excited to have you onboard.</p>
      <p>Click <a href="${this.url}">here</a> to get verified.</p>
    `;

    await this.send(html, "Welcome to the Stamina Plus Family!");
  }
