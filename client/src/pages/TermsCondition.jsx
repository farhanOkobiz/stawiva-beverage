      ...
      <div className="font-inter mb-20">
        <Containar>
          <div className="max-w-5xl mx-auto p-6">
            <p className="mb-4">
              Welcome to Stawiva Beverage ! Before you start shopping, please take a moment
            ...
            <p className="mb-4">
              By accessing or using the Stawiva Beverage website, you agree to comply with
            ...
            <p className="mb-4">
              All content on the Stawiva Beverage website, including text, graphics, logos,
            ...
            <p className="mb-4">
              Stawiva Beverage is not liable for any indirect, incidental, or consequential
